...
export declare class MbscEventListItem extends MbscListItem {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MbscEventListItem, "mbsc-event-list-item", never, { "eventData": "eventData"; "hasDate": "hasDate"; "selected": "selected"; "showColor": "showColor"; "template": "template"; "eventContentTemplate": "eventContentTemplate"; }, {}, never, never>;
}
/**
...
export declare class MbscEventcalendar extends EventcalendarBase implements ICalendarViewHost {
    ...
    /** @hidden */
    _getEventArgs(data: MbscEventList, $event: any, event: MbscCalendarEventData): {
        date: number;
        domEvent: any;
    ...
    /** @hidden */
    _getPopoverEventArgs(state: MbscEventcalendarState, $event: any, event: MbscCalendarEventData): {
        date: number;
        domEvent: any;
        event: MbscCalendarEvent;
        source: string;
